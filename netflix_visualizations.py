...
netflix_stocks is the monthly value, netflix_stocks_quarterly is the daily value 
...
plt.legend(labels)
plt.title('How Did Earnings and Revenue Differ by Quarter?')
...
Revenue and earnings both seem to be increasing at a steady rate and a very small portion of revenue constitues earnings
...
ax1.set_xticklabels(netflix_stocks['Date'], rotation=45, ha='right')
...
ax2.set_xticklabels(dowjones_stocks['Date'], rotation=45, ha='right')
